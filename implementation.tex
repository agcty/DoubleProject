...
As already mentioned, the data used to populate the dashboard with is retrieved from the store. This happens by using vuex store functions as described in \autoref{vuex}. 
